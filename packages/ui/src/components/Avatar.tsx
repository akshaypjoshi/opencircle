...
export const Avatar = ({ ...props }: AvatarProps) => {
	return (
		<RawAvatar.Root>
			<RawAvatar.Image src={props.image_url} alt={props.initials} className={avatarStyles({ ...props})} />
			<RawAvatar.Fallback className={avatarStyles({ ...props })}>{props.initials}</RawAvatar.Fallback>
		</RawAvatar.Root>
